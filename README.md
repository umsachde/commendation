...
Both tools guarantee every result is absent from your Liked Music. `recommend_from_playlist` additionally guarantees every result is absent from the seed playlist itself.
